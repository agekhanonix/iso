        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a href="#" class="tooltip-test" data-toggle="modal" data-target="#login" title="Pour vous connecter à votre compte.">
                    <img src="public/images/connexion.png" class="img-thumbnail">
                </a>    
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a href="#" class="tooltip-test" data-toggle="modal" data-target="#registring" title="Pour créer un compte.">
                    <img src="public/images/creationCompte.png" class="img-thumbnail">
                </a>    
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <form class="form form-horizontal" action="index.php?action=connexion" method="post" accept-charset="utf-8" name="form-login" role="form">
...
<div class="modal fade" id="registring" tabindex="-1" role="dialog" aria-labelledby="registerTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="row">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                    <img src="public/images/creationCompte.png" alt="" width="90%">
                </div>
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <form class="form form-horizontal" action="index.php?action=registring" method="post" accept-charset="utf-8" name="form-login" role="form">
