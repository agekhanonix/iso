                <footer class="footer">
                    <div class="container-fluid">
                        <nav class="float-left">
                            <ul>
                                <li>
                                    <a href="http://www.agekhanonix.fr/index.html">AGEKHANONIX</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="copyright float-right">&copy;
                            ...
                            </script>, made width <i class="fas fa-heartbeat"></i> by <a href="www.agekhanonix.fr/index.html" target="_blank">AGEKHANONIX</a>
                        </div>
                    </div>
                </footer>
            </div>
